    ...
    <View className="bg-BACKGROUND h-full">
      <View>
        ...
        <View className="flex-row justify-center mt-4 relative">
          ...
          <TouchableOpacity className="absolute bottom-0 right-40 bg-white p-1 rounded-full">
            <MaterialCommunityIcons name="lead-pencil" size={18} color="black" />
          </TouchableOpacity>
        </View>
        <Text className="text-center text-xl mt-4" style={{fontWeight:'bold'}}>{user?.fullName}</Text>
